...
@section('content')
     ...
     <table class="shoucangtab">
      <tr>
       ...
       <td width="25%" align="center" style="background:#fff url({{url('mall/images')}}/xian.jpg) left center no-repeat;"><a href="javascript:;" class="orange">全部删除</a></td>
      </tr>
     </table>
     ...
     <div class="dingdanlist" onClick="window.location.href='proinfo.html'">
      <table>
       ...
       <tr>
        <td class="dingimg" width="15%"><img src="{{url('mall/images')}}/pro1.jpg" /></td>
        <td width="50%">
         <h3>三级分销农庄有机瓢瓜400g</h3>
         <time>下单时间：2015-08-11  13:51</time>
        </td>
        <td align="right"><img src="{{url('mall/images')}}/jian-new.png" /></td>
       </tr>
       <tr>
